...
export class PricingService {
    static async calculateTotalPrice(facilityId, courtType, startDateTime, endDateTime, userId) {
        ...
        if (userId) {
            ...
            if (user)
                userMembership = user.membership_type; // 'student' hoặc 'vip'
        }
        ...
        const strategy = PricingStrategyFactory.createStrategy(holiday, userMembership, isWeekend, studentDiscount, weekendSurcharge);
