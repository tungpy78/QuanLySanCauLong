...
class PriceConfigRepository extends BaseRepository {
    constructor() {
        super(models.PriceConfig);
    }
    // Hàm đặc thù 1: Lấy tất cả cấu hình giá kèm tên Cơ sở
    async findAllWithFacility(facilityId) {
    ...
    async findOverlap(facilityId, courtType, startTime, endTime, excludeId) {
...
//# sourceMappingURL=priceConfig.repository.js.map