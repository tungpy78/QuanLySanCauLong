...
export class VNPayUtils {
    static tmnCode = process.env.VNP_TMNCODE || '';
    static hashSecret = process.env.VNP_HASHSECRET || '';
    static vnpUrl = process.env.VNP_URL || 'https://sandbox.vnpayment.vn/paymentv2/vpcpay.html';
    static returnUrl = process.env.VNP_RETURNURL || '';
    /**
     ...
     */
    static verifyIpnSignature(vnpayParams) {
