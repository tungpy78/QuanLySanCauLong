...
export const updateVariantSchema = z.object({
    ...
    body: variantCoreSchema.partial().refine((data) => Object.keys(data).length > 0, { message: 'Bạn phải gửi ít nhất 1 trường dữ liệu cần cập nhật' })
});
